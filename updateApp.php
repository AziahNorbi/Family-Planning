				...
				<div class="grids">
					<div class="panel panel-widget forms-panel">
						<div class="progressbar-heading general-heading">
							<center><h4> Update Appointment for mother </h4></center>
						</div>
						<div class="forms">
								<h3 class="title1"></h3>
							...
							$query = "SELECT * FROM appointment WHERE icMother='$a'";
							$result = mysql_query ($query);
							//nama dari form
							while($row = mysql_fetch_array($result)){
							//echo "<option value=".$r['icMother'].">".$r['icMother']."</option>";//nama dari db
				             $a=$row['icMother'];//dari nama form
	                         $w=$row['dateApp'];//dari nama form
	                         $y=$row['timeApp'];//dari nama form
	                         $z=$row['dayApp'];//dari nama form
            
							}
			?>
			<form class="form-horizontal" action="updateApp2.php" method="post">
			
				<div class="form-group">
				<label for="focusedinput" class="col-sm-2 control-label">Identication card </label>
				<div class="col-sm-8">
			   <input type="text" class="form-control1" name="icMother" id="icMother" value="<?php echo $a ?>" >
...
document.getElementById('dateApp').value = day+"/"+month+"/"+year;
var theevent = "";
var floater = 0;
...
<table id="evtcal" border="0" cellpadding="0" cellspacing="0" width="584">
	<tbody>
        ...
        <div class="form-group">
				<label for="focusedinput" class="col-sm-2 control-label">Date Appointment </label>
				<div class="col-sm-8">
				<input type="text" class="form-control1" name="dateApp" id="dateApp" value="<?php echo $w ?>" required="required">
				</div>
				</div>
		<div class="form-group">
				<label for="focusedinput" class="col-sm-2 control-label">Time Appointment </label>
				<div class="col-sm-8">
						  <select id="timeApp" name="timeApp" required="required">
		...
		<div class="form-group">
				<label for="focusedinput" class="col-sm-2 control-label">Appointment Day</label>
				<div class="col-sm-8">
				   <select name="AppDay" id="AppDay" required="required">
				...
				<div class="col-sm-8">
				<input type="text" class="form-control1" name="noS" id="noS" value="<?php echo $x ?>" required="required" >
				</div>
				</div> 
