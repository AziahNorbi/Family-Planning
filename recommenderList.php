				...
				<div class="grids">
					<div class="panel panel-widget forms-panel">
						<div class="progressbar-heading general-heading">
							<center><h4> Recommendation List </h4></center>
						</div>
						<div class="forms">
								<h3 class="title1"></h3>
...
<table id="evtcal" border="0" cellpadding="0" cellspacing="0" width="584">
	<tbody>
		...
		<div class="form-group">
				...
				<div class="col-sm-8">
				<input type="text" class="form-control1" name="dateDecision" id="dateDecision" placeholder="Date Decision" required="required">
				</div>
				</div>
		...
		<div class="form-group">
				...
				<div class="col-sm-8">
				<input type="text" class="form-control1" name="dateRecommend" id="dateRecommend" placeholder="Date Recommend" required="required">
				</div>
				</div>
		<hr>
			<div class="form-group">
